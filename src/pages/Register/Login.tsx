      ...
      <div className="w-[40%] h-screen bg-[#f5f5f5] flex flex-col justify-between py-7">
        <div className="bg-white  mx-16 mt-7 p-7 rounded-2xl">
          ...
          <form action="" className="mt-5">
            <div className="mb-5">
              ...
              <div className="flex items-center border-2 border-[#DADAE7] py-4 gap-3 px-3 text-sm">
                ...
                <input type="email" placeholder="Email here" className="w-full focus:outline-none" />
              </div>
            </div>
            <div className="mb-5">
              ...
              <div className="flex items-center border-2 border-[#DADAE7] py-4 gap-3 px-3 text-sm">
                ...
                <input type="password" placeholder="Password here" className="w-full focus:outline-none" />
              </div>
          ...
          <div className="mt-12 flex flex-col justify-center items-center">
            ...
            <p className="text-base text-green font-semibold cursor-pointer">Create an account</p>
          </div>
        </div>

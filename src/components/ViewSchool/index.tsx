                        ...
                        <div className='bg-[#E7FAFF] h-[62px] flex items-center justify-between' >
                            ...
                            <Modal
                                trigger={
                                    ...
                                    <span className='pr-2' ><Icon id='plus-icon' width={16} height={16} /></span> Write a Review / Rating</p>
                                }
                            >
                                {(close: () => void) => (
                                <div>
                ...
                <div className='md:pl-10 w-full tab:pt-5' >
                    <div>
                        ...
                        <p onClick={()=>{
                            ...
                            }} className='md:hidden text-primary text-[14px] leading-[22.4px] cursor-pointer py-1' >Tap to view ratings</p>
